    ...
    >
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid gap-4 lg:grid-cols-2 lg:gap-8">
          ...
          <motion.div
            variants={fadeUp}
            className="order-2 lg:order-1 flex flex-col justify-center space-y-4"
          >
            <h1
              id="hero-heading"
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl">
              Find relevant roles for job experience or choose a project that’s
              meaningful, impactful and right for you.
            </p>
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <SignUpButton mode="modal" forceRedirectUrl="/onboard">
                <Button
                  size="lg"
                  className="px-8 py-4 text-white hover:bg-blue-700 transition duration-200 ease-in-out"
                >
                  Get Started
